...
public class StudentManager {
    ...
    public static Student fetchStudent(String id) throws NoSuchRecordException {
        ...
        ResultSet rs = null;
        try {
            String sql = "SELECT s.name, s.first_name, s.degree, d.name AS degree_name FROM STUDENTS AS s JOIN DEGREES AS d ON s.degree = d.id WHERE s.id = ?";
            ...
            throw new NoSuchRecordException("empty result set");
